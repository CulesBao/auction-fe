      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
        ...
        {images.length < maxImages && (
          <button
            ...
            className="aspect-square rounded-lg border-2 border-dashed border-gray-600 hover:border-[#256af4] bg-[#1a1a1a] hover:bg-[#242424] flex flex-col items-center justify-center gap-2 text-gray-400 hover:text-[#256af4] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isUploading ? (
              <LoadingSpinner size="sm" />
            ) : (
